...
function getTodos() {
    ...
    axios.get('https://jsonplaceholder.typicode.com/todos?_limit=5', {timeout: 90})
  ...
  const axiosInstance1 = axios.create({
    // there can be other custom settings as well
    baseURL: 'https://jsonplaceholder.typicode.com'
  });

  axiosInstance1.get('/comments').then(res => showOutput(res));
